...
const Index = () => {
  ...
  <defs>
    <style>{`
      ...
      /* 手機機身：白色填充 + 螢幕鏤空 (利用 fill-rule: evenodd) */
      .qs-shell { 
        fill: #ffffff; 
        stroke: #b9aa80; 
        stroke-width: 4; 
      ...
      /* 2. QR Code 中心縮小消失 (2.4s 開始) */
      @keyframes qs-qr-transform { 
        0%, 55% { opacity: 1; transform: scale(1); } 
        65%, 100% { opacity: 0; transform: scale(0.4); } 
      }

      /* 3. 打勾中心彈出顯現 (2.4s 開始) */
      @keyframes qs-check-in { 
        0%, 62% { stroke-dashoffset: 45; opacity: 0; transform: scale(0.6); } 
        75% { stroke-dashoffset: 0; opacity: 1; transform: scale(1.1); } 
        85%, 92% { stroke-dashoffset: 0; opacity: 1; transform: scale(1); } 
        100% { opacity: 0; } 
      }

      /* 4. 掃描線上下移動 (1.8s - 2.4s) */
      @keyframes qs-scan-action { 
      ...
      /* 動畫掛載 */
      .qs-main-group { 
        animation: qs-phone-shake 4s infinite ease-in-out; 
        transform-origin: center; 
      }
      .qs-qr { 
        transform-origin: center; 
        transform-box: fill-box; 
        animation: qs-qr-transform 4s infinite ease-in-out; 
      }
      .qs-checkmark { 
        stroke-dasharray: 45; 
        ...
        transform-origin: center; 
        transform-box: fill-box; 
        animation: qs-check-in 4s infinite ease-out; 
      }
      .qs-scanbar { 
        animation: qs-scan-action 4s infinite linear; 
      }
    `}</style>
  </defs>
  ...
  <g className="qs-main-group">
    ...
    {/* QR Code */}
    <g className="qs-qr" transform="translate(73, 65)">
      ...
      <rect fill="#ffffff" x="40" y="4" width="10" height="10" rx="1" />
